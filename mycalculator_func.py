...
with project_client:
    agent = project_client.agents.create_agent(
        model="gpt-4",
        name="ai-agent-demo",
        instructions="You are a helpful assistant that performs web searches and calculations, choosing the appropriate tool based on the query.",
        toolset=toolset,
    ...
    # User's message
    #user_input = "what is weather of Mumabi today?"
